...
public class MainAttachment {
    ...
    public static final Supplier<AttachmentType<EarthList>> EARTHLIST = ATTACHMENT_TYPES.register("earthList", () -> AttachmentType.<EarthList>builder(() -> new EarthList()).serialize(EarthList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<FireList>> FIRELIST = ATTACHMENT_TYPES.register("fireList", () -> AttachmentType.<FireList>builder(() -> new FireList()).serialize(FireList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<LightningList>> LIGHTINGLIST = ATTACHMENT_TYPES.register("lightningList", () -> AttachmentType.<LightningList>builder(() -> new LightningList()).serialize(LightningList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<WaterList>> WATERLIST = ATTACHMENT_TYPES.register("waterList", () -> AttachmentType.<WaterList>builder(() -> new WaterList()).serialize(WaterList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<WindList>> WINDLIST = ATTACHMENT_TYPES.register("windList", () -> AttachmentType.<WindList>builder(() -> new WindList()).serialize(WindList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<YangList>> YANGLIST = ATTACHMENT_TYPES.register("yangList", () -> AttachmentType.<YangList>builder(() -> new YangList()).serialize(YangList.CODEC).copyOnDeath().build());
    public static final Supplier<AttachmentType<YingList>> YINGLIST = ATTACHMENT_TYPES.register("yingList", () -> AttachmentType.<YingList>builder(() -> new YingList()).serialize(YingList.CODEC).copyOnDeath().build());
