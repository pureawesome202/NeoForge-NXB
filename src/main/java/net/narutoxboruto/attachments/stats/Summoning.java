...
import net.narutoxboruto.networking.stats.SyncSummoning;
...
public class Summoning {
    ...
    public static final Codec<Summoning> CODEC = Codec.INT.xmap(value -> {Summoning summoning = new Summoning();summoning.value = value;return summoning;}, Summoning::getValue);
    ...
    public void syncValue(ServerPlayer serverPlayer) {
        ModPacketHandler.sendToPlayer(new SyncSummoning(getValue()), serverPlayer);
    }
