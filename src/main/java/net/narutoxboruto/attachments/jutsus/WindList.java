...
import net.narutoxboruto.networking.jutsus.SyncWindList;
...
public class WindList {
    ...
    public WindList(String id, String value) {
        this.id = id;
        this.value = value;
    }

    // Default constructor
    public WindList(String identifier) {
        this.id = identifier;
        this.value = "";
    }
    ...
    public Object getSyncMessage() {
        return new SyncWindList(this.value);
    }
