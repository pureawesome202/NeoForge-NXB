...
import net.narutoxboruto.networking.selection.SyncSelectionWater;
import net.narutoxboruto.util.ModUtil;

public class SelectedWater {
    private final String id;
    protected String value = "";

    // Codec for serialization
    public static final Codec<SelectedWater> CODEC = Codec.STRING.xmap(SelectedWater::new, SelectedWater::getValue);


    // Constructor for codec
    public SelectedWater(String id, String value) {
        this.id = id;
        this.value = value;
    }

    // Default constructor
    public SelectedWater(String identifier) {
        this.id = identifier;
        this.value = "";
    }

    public SelectedWater() {
        this("selectedwater");
    }

    public Object getSyncMessage() {
        return new SyncSelectionWater(this.value);
    }
